 ...
 */
export function AttemptDots({ attemptCount, maxAttempts = 6 }: AttemptDotsProps) {
  const dots = Array.from({ length: maxAttempts }, (_, i) => i < attemptCount);
  
  return (
    <div className="flex items-center gap-2" aria-label={`${attemptCount} of ${maxAttempts} attempts used`}>
