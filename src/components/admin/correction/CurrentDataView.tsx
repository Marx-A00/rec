  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-6">
        {/* Cover art */}
        <div className="w-32 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-zinc-800">
          <AlbumImage
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-muted-foreground">{primaryArtistName}</p>
        </div>
      </div>
        ...
        <AccordionItem value="basic">
          ...
          <AccordionContent>
            <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
              ...
              <dt className="text-muted-foreground">Primary Artist</dt>
              <dd>{primaryArtistName}</dd>
              ...
              <dd>{album.releaseType ?? '—'}</dd>

              <dt className="text-muted-foreground">Label</dt>
              <dd>{album.label ?? '—'}</dd>

              <dt className="text-muted-foreground">Barcode</dt>
              <dd className="font-mono text-xs">{album.barcode ?? '—'}</dd>
            </dl>
          </AccordionContent>
        </AccordionItem>
