...
export default function PanelSelector({ onSelect, onClose }: PanelSelectorProps) {
    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-800">
          <h2 className="text-xl font-semibold text-white">Select Panel Type</h2>
          <button
            onClick={onClose}
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`p-2 rounded-lg bg-zinc-900 ${config.color} group-hover:scale-110 transition-transform`}>
