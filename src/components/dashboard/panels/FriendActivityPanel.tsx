      ...
      const fetchActivities = async () => {
        ...
        try {
          ...
          setTimeout(() => {
            const mockActivities: FriendActivity[] = [
              {
                ...
                type: 'recommendation',
                album: { id: '1', title: 'Random Access Memories', artist: 'Daft Punk', imageUrl: '/demo-albums/RAM-daft-punk.jpeg' },
              ...
              },
              {
                ...
                type: 'collection_add',
                album: { id: '2', title: 'BRAT', artist: 'Charli XCX', imageUrl: '/Charli_XCX_-_Brat_(album_cover).png' },
              ...
              },
              {
                ...
                type: 'rating',
                album: { id: '3', title: 'Discovery', artist: 'Daft Punk', imageUrl: '/demo-albums/discovery-daft-punk.jpg' },
              ...
              },
              {
                ...
                friend: mockFriends[0],
                type: 'collection_add',
                album: { id: '4', title: 'Reflections', artist: 'Hannah Diamond', imageUrl: '/reflections-hannah-diamond.webp' },
                description: 'added to collection',
            ...
            const filteredActivities = selectedFriend === 'all' 
              ? mockActivities 
              : mockActivities.filter(activity => activity.friend.id === selectedFriend);
            ...
            <div className="relative">
              ...
              >
                <span className="text-sm">
                  {selectedFriend === 'all' ? 'All Friends' : friends.find(f => f.id === selectedFriend)?.name || 'All Friends'}
                </span>
