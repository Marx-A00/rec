...
export function MobilePlayClient() {
  ...
  useEffect(() => {
    ...
    // Always call startGame — the backend returns the existing session
    // if one already exists, along with the imageUrl we need to display.
    // Without this, returning to the page with a persisted sessionId
    // would leave challengeImageUrl null (no image).
