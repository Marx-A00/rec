        ...
        <div className="w-full space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            <AlbumCard
              ...
              placeholder={isSearchingForBasis ? "Search for an album above" : "Click to search for a basis album"}
            />
            ...
            <AlbumCard
              ...
              placeholder={!isSearchingForBasis ? "Search for an album above" : "Click to search for a recommended album"}
            />
          </div>
