  ...
  return (
    <Tabs defaultValue="discography" className="w-full">
      <TabsList className="grid w-full grid-cols-4 bg-zinc-900">
        <TabsTrigger value="discography" className="data-[state=active]:bg-zinc-800">
          Discography
        </TabsTrigger>
        <TabsTrigger value="recs" className="data-[state=active]:bg-zinc-800">
          Recs
        </TabsTrigger>
        <TabsTrigger value="chinese-wisdom" className="data-[state=active]:bg-zinc-800">
          Chinese Wisdom
        </TabsTrigger>
        <TabsTrigger value="similar-artists" className="data-[state=active]:bg-zinc-800">
          Similar Artists
        </TabsTrigger>
      </TabsList>
...
function ChineseWisdomTabContent({ artistId }: { artistId: string }){
  return (
    <div className="bg-zinc-900 p-4 rounded-lg">
...
function SimilarArtistsTabContent({ artistId }: { artistId: string }){
  return (
    <div className="bg-zinc-900 p-4 rounded-lg">
