 ...
 * Identifies compilations, deluxe reissues, live recordings, remasters, etc.
 *
 * Used by:
 * - Deezer playlist import preview (yellow warning badges, auto-deselection)
 * - Deezer editorial sync (optional filtering of non-standard releases)
 * - Any future sync source that needs to filter release variants
 */
