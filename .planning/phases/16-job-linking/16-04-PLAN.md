...
8. Wrap entire function in try-catch, log FAILED in catch block:
  ...
  <verify>
1. handleDiscogsSearchArtist accepts Job<DiscogsSearchArtistJobData>
2. All 4 code paths log: no results, no match, success, failure
3. DISCOGS_GET_ARTIST job spawn includes parentJobId
  </verify>
...
6. Wrap in try-catch, log FAILED in catch:
  ...
  <verify>
1. handleDiscogsGetArtist accepts Job<DiscogsGetArtistJobData>
2. All 3 code paths log: no image, success, failure
3. CACHE_ARTIST_IMAGE job spawn includes parentJobId
  </verify>
