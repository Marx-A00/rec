...
9. In catch block, log failure:
   ...
   <verify>
10. handleCacheArtistImage accepts Job<CacheArtistImageJobData>
11. All 6 code paths log: not found, already cached, no URL, fetch failed, success, error
12. Metadata includes image URLs and Cloudflare IDs
    </verify>
...
8. In catch block, log failure:
   ...
   <verify>
9. handleCacheAlbumCoverArt accepts Job<CacheAlbumCoverArtJobData>
10. All 6 code paths log: not found, already cached, no URL, fetch failed, success, error
11. Metadata includes album title and image URLs
    </verify>
