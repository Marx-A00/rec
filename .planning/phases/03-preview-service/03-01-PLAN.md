...
must_haves:
  ...
  artifacts:
    - path: "src/lib/correction/preview/types.ts"
      ...
      exports: ["ChangeType", "FieldDiff", "TextDiff", "DateDiff", "ArrayDiff", "TrackDiff", "CorrectionPreview"]
 ...
 */
export function parseDateComponents(dateString: string | null | undefined): DateComponents | null {
 ...
 */
export function formatDateComponents(components: DateComponents | null): string {
