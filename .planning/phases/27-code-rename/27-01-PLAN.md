...
<task type="auto">
  ...
  <done>LlamaLogger class is exported and uses LlamaLog Prisma model</done>
</task>
...
<task type="auto">
  ...
  <verify>
  Run: `grep -r "EnrichmentLogger" src/lib/queue/processors/ src/lib/musicbrainz/ src/lib/enrichment/`
  Should return empty (no matches) except for potentially the old enrichment-logger.ts file.
  </verify>
  <done>All processors import and use LlamaLogger from new location</done>
</task>
