...
5. Ensure the badge uses the same styling as the album preview badge for consistency:
  ...
  <verify>
1. Badge import exists: grep "Badge" src/components/admin/correction/artist/preview/ArtistPreviewView.tsx
2. correctionSource read: grep "correctionSource" src/components/admin/correction/artist/preview/ArtistPreviewView.tsx
