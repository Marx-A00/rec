...
decisions:
  - id: "09-03-01"
    ...
    alternatives: ["Just show generic success message", "Show detailed field list"]
...
const trackCount = changes.tracks.added + changes.tracks.modified + changes.tracks.removed;
