...
Note: CREATE-02 (addAlbumToCollection) is NOT an album creation path — that mutation links existing albums to collections, it does not create new albums. See 28-CONTEXT.md for clarification.
